...
int main(int argc, char *argv[]) {
	...
	printf("Enter data for all 25 names:");	
...
void sortingEnglishScores() {
	...
	char* tempName;
	char* tempRollNum;
	char* duplicateName[25];
	char* duplicateRollNum[25];
